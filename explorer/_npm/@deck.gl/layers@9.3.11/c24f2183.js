 ...
 * Original file: /npm/@deck.gl/layers@9.3.11/dist/index.js
 *
 * Do NOT use SRI with dynamically generated files! More information: https://www.jsdelivr.com/using-sri-with-dynamic-files
 */
import{Layer as E,project32 as z,picking as O,UNIT as I,createIterable as J,color as Y,log as b,gouraudMaterial as fe,phongMaterial as Tt,Tesselator as Oe,CompositeLayer as pe}from"../core@9.3.11/98205566.js";import{Model as S,Geometry as R,CubeGeometry as It}from"../../@luma.gl/engine@9.3.6/1e8e1216.js";import{lngLatToWorld as Re}from"../../@math.gl/web-mercator@4.1.0/3f7a5984.js";import{lerp as he}from"../../@math.gl/core@4.1.0/9ca9810c.js";import{load as Mt}from"../../@loaders.gl/core@4.4.5/893a1fec.js";import{modifyPolygonWindingDirection as ve,WINDING as me,cutPolylineByGrid as Et,cutPolylineByMercatorBounds as zt,cutPolygonByGrid as Ot,cutPolygonByMercatorBounds as Rt}from"../../@math.gl/polygon@4.1.0/49b02c6d.js";import kt from"../../earcut@2.2.4/94e23b08.js";import Ft from"../../@mapbox/tiny-sdf@2.2.0/4e5750a9.js";const ke=`layout(std140) uniform arcUniforms {
  bool greatCircle;
...
`,Ei={name:"column",vs:Je,fs:Je,uniformTypes:{radius:"f32",angle:"f32",offset:"vec2<f32>",extruded:"f32",stroked:"f32",isStroke:"f32",coverage:"f32",elevationScale:"f32",edgeDistance:"f32",widthScale:"f32",widthMinPixels:"f32",widthMaxPixels:"f32",radiusUnits:"i32",widthUnits:"i32"}};var zi=`#version 300 es
...
`;const se=[0,0,0,255],to={filled:!0,extruded:!1,wireframe:!1,_normalize:!0,_windingOrder:"CW",_full3d:!1,elevationScale:{type:"number",min:0,value:1},getPolygon:{type:"accessor",value:n=>n.polygon},getElevation:{type:"accessor",value:1e3},getFillColor:{type:"accessor",value:se},getLineColor:{type:"accessor",value:se},material:!0},ne={enter:(n,e)=>e.length?e.subarray(e.length-n.length):n};class K extends E{getShaders(e){return super.getShaders({vs:e==="top"?qi:Qi,fs:eo,defines:{RING_WINDING_ORDER_CW:!this.props._normalize&&this.props._windingOrder==="CCW"?0:1},modules:[z,fe,O,Yi]})}get wrapLongitude(){return!1}getBounds(){return this.getAttributeManager()?.getBounds(["vertexPositions"])}initializeState(){const{viewport:e}=this.context;let{coordinateSystem:t}=this.props;const{_full3d:i}=this.props;e.isGeospatial&&t==="default"&&(t="lnglat");let o;t==="lnglat"&&(i?o=e.projectPosition.bind(e):o=e.projectFlat.bind(e)),this.setState({numInstances:0,polygonTesselator:new Ji({preproject:o,fp64:this.use64bitPositions(),IndexType:Uint32Array})});const s=this.getAttributeManager(),r=!0;s.remove(["instancePickingColors"]),s.add({indices:{size:1,isIndexed:!0,update:this.calculateIndices,noAlloc:r},vertexPositions:{size:3,type:"float64",stepMode:"dynamic",fp64:this.use64bitPositions(),transition:ne,accessor:"getPolygon",update:this.calculatePositions,noAlloc:r,shaderAttributes:{nextVertexPositions:{vertexOffset:1}}},instanceVertexValid:{size:1,type:"uint16",stepMode:"instance",update:this.calculateVertexValid,noAlloc:r},elevations:{size:1,stepMode:"dynamic",transition:ne,accessor:"getElevation"},fillColors:{size:this.props.colorFormat.length,type:"unorm8",stepMode:"dynamic",transition:ne,accessor:"getFillColor",defaultValue:se},lineColors:{size:this.props.colorFormat.length,type:"unorm8",stepMode:"dynamic",transition:ne,accessor:"getLineColor",defaultValue:se},pickingColors:{size:4,type:"uint8",stepMode:"dynamic",accessor:(a,{index:l,target:d})=>this.encodePickingColor(a&&a.__source?a.__source.index:l,d)}})}getPickingInfo(e){const t=super.getPickingInfo(e),{index:i}=t,o=this.props.data;return o[0]&&o[0].__source&&(t.object=o.find(s=>s.__source.index===i)),t}disablePickingIndex(e){const t=this.props.data;if(t[0]&&t[0].__source)for(let i=0;i<t.length;i++)t[i].__source.index===e&&this._disablePickingIndex(i);else super.disablePickingIndex(e)}draw({uniforms:e}){const{extruded:t,filled:i,wireframe:o,elevationScale:s}=this.props,{topModel:r,sideModel:a,wireframeModel:l,polygonTesselator:d}=this.state,c={extruded:!!t,elevationScale:s,isWireframe:!1};l&&o&&(l.setInstanceCount(d.instanceCount-1),l.shaderInputs.setProps({solidPolygon:{...c,isWireframe:!0}}),l.draw(this.context.renderPass)),a&&i&&(a.setInstanceCount(d.instanceCount-1),a.shaderInputs.setProps({solidPolygon:c}),a.draw(this.context.renderPass)),r&&i&&(r.setVertexCount(d.vertexCount),r.shaderInputs.setProps({solidPolygon:c}),r.draw(this.context.renderPass))}updateState(e){super.updateState(e),this.updateGeometry(e);const{props:t,oldProps:i,changeFlags:o}=e,s=this.getAttributeManager();(o.extensionsChanged||t.filled!==i.filled||t.extruded!==i.extruded)&&(this.state.models?.forEach(a=>a.destroy()),this.setState(this._getModels()),s.invalidateAll())}updateGeometry({props:e,oldProps:t,changeFlags:i}){if(i.dataChanged||i.updateTriggersChanged&&(i.updateTriggersChanged.all||i.updateTriggersChanged.getPolygon)){const{polygonTesselator:s}=this.state,r=e.data.attributes||{};s.updateGeometry({data:e.data,normalize:e._normalize,geometryBuffer:r.getPolygon,buffers:r,getGeometry:e.getPolygon,positionFormat:e.positionFormat,wrapLongitude:e.wrapLongitude,resolution:this.context.viewport.resolution,fp64:this.use64bitPositions(),dataChanged:i.dataChanged,full3d:e._full3d}),this.setState({numInstances:s.instanceCount,startIndices:s.vertexStarts}),i.dataChanged||this.getAttributeManager().invalidateAll()}}_getModels(){const{id:e,filled:t,extruded:i}=this.props;let o,s,r;if(t){const a=this.getShaders("top");a.defines.NON_INSTANCED_MODEL=1;const l=this.getAttributeManager().getBufferLayouts({isInstanced:!1});o=new S(this.context.device,{...a,id:`${e}-top`,topology:"triangle-list",bufferLayout:l,isIndexed:!0,userData:{excludeAttributes:{instanceVertexValid:!0}}})}if(i){const a=this.getAttributeManager().getBufferLayouts({isInstanced:!0});s=new S(this.context.device,{...this.getShaders("side"),id:`${e}-side`,bufferLayout:a,geometry:new R({topology:"triangle-strip",attributes:{positions:{size:2,value:new Float32Array([1,0,0,0,1,1,0,1])}}}),isInstanced:!0,userData:{excludeAttributes:{indices:!0}}}),r=new S(this.context.device,{...this.getShaders("side"),id:`${e}-wireframe`,bufferLayout:a,geometry:new R({topology:"line-strip",attributes:{positions:{size:2,value:new Float32Array([1,0,0,0,0,1,1,1])}}}),isInstanced:!0,userData:{excludeAttributes:{indices:!0}}})}return{models:[s,r,o].filter(Boolean),topModel:o,sideModel:s,wireframeModel:r}}calculateIndices(e){const{polygonTesselator:t}=this.state;e.startIndices=t.indexStarts,e.value=t.get("indices")}calculatePositions(e){const{polygonTesselator:t}=this.state;e.startIndices=t.vertexStarts,e.value=t.get("positions")}calculateVertexValid(e){e.value=this.state.polygonTesselator.get("vertexValid")}}K.defaultProps=to,K.layerName="SolidPolygonLayer";function lt({data:n,getIndex:e,dataRange:t,replace:i}){const{startRow:o=0,endRow:s=1/0}=t,r=n.length;let a=r,l=r;for(let g=0;g<r;g++){const f=e(n[g]);if(a>g&&f>=o&&(a=g),f>=s){l=g;break}}let d=a;const u=l-a!==i.length?n.slice(l):void 0;for(let g=0;g<i.length;g++)n[d++]=i[g];if(u){for(let g=0;g<u.length;g++)n[d++]=u[g];n.length=d}return{startRow:a,endRow:a+i.length}}const ct=[0,0,0,255],io=[0,0,0,255],oo={stroked:!0,filled:!0,extruded:!1,elevationScale:1,wireframe:!1,_normalize:!0,_windingOrder:"CW",lineWidthUnits:"meters",lineWidthScale:1,lineWidthMinPixels:0,lineWidthMaxPixels:Number.MAX_SAFE_INTEGER,lineJointRounded:!1,lineMiterLimit:4,getPolygon:{type:"accessor",value:n=>n.polygon},getFillColor:{type:"accessor",value:io},getLineColor:{type:"accessor",value:ct},getLineWidth:{type:"accessor",value:1},getElevation:{type:"accessor",value:1e3},material:!0};class we extends pe{initializeState(){this.state={paths:[],pathsDiff:null},this.props.getLineDashArray&&b.removed("getLineDashArray","PathStyleExtension")()}updateState({changeFlags:e}){const t=e.dataChanged||e.updateTriggersChanged&&(e.updateTriggersChanged.all||e.updateTriggersChanged.getPolygon);if(t&&Array.isArray(e.dataChanged)){const i=this.state.paths.slice(),o=e.dataChanged.map(s=>lt({data:i,getIndex:r=>r.__source.index,dataRange:s,replace:this._getPaths(s)}));this.setState({paths:i,pathsDiff:o})}else t&&this.setState({paths:this._getPaths(),pathsDiff:null})}_getPaths(e={}){const{data:t,getPolygon:i,positionFormat:o,_normalize:s}=this.props,r=[],a=o==="XY"?2:3,{startRow:l,endRow:d}=e,{iterable:c,objectInfo:u}=J(t,l,d);for(const g of c){u.index++;let f=i(g,u);s&&(f=ot(f,a));const{holeIndices:p}=f,v=f.positions||f;if(p)for(let h=0;h<=p.length;h++){const y=v.slice(p[h-1]||0,p[h]||v.length);r.push(this.getSubLayerRow({path:y},g,u.index))}else r.push(this.getSubLayerRow({path:v},g,u.index))}return r}renderLayers(){const{data:e,_dataDiff:t,stroked:i,filled:o,extruded:s,wireframe:r,_normalize:a,_windingOrder:l,elevationScale:d,transitions:c,positionFormat:u}=this.props,{lineWidthUnits:g,lineWidthScale:f,lineWidthMinPixels:p,lineWidthMaxPixels:v,lineJointRounded:h,lineMiterLimit:y,lineDashJustified:_}=this.props,{getFillColor:w,getLineColor:m,getLineWidth:x,getLineDashArray:A,getElevation:M,getPolygon:T,updateTriggers:L,material:N}=this.props,{paths:F,pathsDiff:k}=this.state,B=this.getSubLayerClass("fill",K),G=this.getSubLayerClass("stroke",$),U=this.shouldRenderSubLayer("fill",F)&&new B({_dataDiff:t,extruded:s,elevationScale:d,filled:o,wireframe:r,_normalize:a,_windingOrder:l,getElevation:M,getFillColor:w,getLineColor:s&&r?m:ct,material:N,transitions:c},this.getSubLayerProps({id:"fill",updateTriggers:L&&{getPolygon:L.getPolygon,getElevation:L.getElevation,getFillColor:L.getFillColor,lineColors:s&&r,getLineColor:L.getLineColor}}),{data:e,positionFormat:u,getPolygon:T}),C=!s&&i&&this.shouldRenderSubLayer("stroke",F)&&new G({_dataDiff:k&&(()=>k),widthUnits:g,widthScale:f,widthMinPixels:p,widthMaxPixels:v,jointRounded:h,miterLimit:y,dashJustified:_,_pathType:"loop",transitions:c&&{getWidth:c.getLineWidth,getColor:c.getLineColor,getPath:c.getPolygon},getColor:this.getSubLayerAccessor(m),getWidth:this.getSubLayerAccessor(x),getDashArray:this.getSubLayerAccessor(A)},this.getSubLayerProps({id:"stroke",updateTriggers:L&&{getWidth:L.getLineWidth,getColor:L.getLineColor,getDashArray:L.getLineDashArray}}),{data:F,positionFormat:u,getPath:P=>P.path});return[!s&&U,C,s&&U]}}we.layerName="PolygonLayer",we.defaultProps=oo;function so(n,e){if(!n)return null;const t="startIndices"in n?n.startIndices[e]:e,i=n.featureIds.value[t];return t!==-1?no(n,i,t):null}function no(n,e,t){const i={properties:{...n.properties[e]}};for(const o in n.numericProps)i.properties[o]=n.numericProps[o].value[t];return i}function ro(n,e){const t={points:null,lines:null,polygons:null};for(const i in t){const o=n[i].globalFeatureIds.value;t[i]=new Uint8ClampedArray(o.length*4);const s=[];for(let r=0;r<o.length;r++)e(o[r],s),t[i][r*4+0]=s[0],t[i][r*4+1]=s[1],t[i][r*4+2]=s[2],t[i][r*4+3]=255}return t}const dt=`layout(std140) uniform sdfUniforms {
  float gamma;
  bool enabled;
  float buffer;
  float outlineBuffer;
...
`,ao={name:"sdf",vs:dt,fs:dt,uniformTypes:{gamma:"f32",enabled:"f32",buffer:"f32",outlineBuffer:"f32",outlineColor:"vec4<f32>"}},Z={none:0,start:1,center:2,end:3},lo=`layout(std140) uniform textUniforms {
...
#define ALIGN_MODE_START ${Z.start}
#define ALIGN_MODE_CENTER ${Z.center}
#define ALIGN_MODE_END ${Z.end}
`,ut={name:"text",vs:lo,getUniforms:({contentCutoffPixels:n=[0,0],contentAlignHorizontal:e="none",contentAlignVertical:t="none",fontSize:i,viewport:o})=>({cutoffPixels:n,align:[Z[e],Z[t]],fontSize:i,flipY:o?.flipY??!1}),uniformTypes:{cutoffPixels:"vec2<f32>",align:"vec2<i32>",fontSize:"f32",flipY:"f32"}};var co=`#version 300 es
